(mes
 ...
 (seg*
  ...
  (cmd:204 100 199)
  (set-reg 100 #t)
  (exec-mem 35072 "#101=(#702==0)")
  (set-reg 110 #t)
  (exec-mem 35072 "#111=#555")
  (set-reg 120 #t)
  (set-reg 121 #t)
  (set-reg 122 #t)
  (set-reg 123 #t)
 ...
 (seg (? (= X 0) (= S 2) (= 700 #t))
      (nop@)
      (exec-mem 14080 0)
      (exec-mem 8192 "G 10 15 240 32 64")
      (exec-mem 256 15 30 31 8 1 1 0 2560 2560 1 1)
      (exec-mem 256 15 30 30 7 1 0 0 2560 2560 1 0)
      (text-frame 16 250 79 275)
      (text "ガイは出かけたはずだし、今は" 'br)
      (text "まだ顔を合わせたくはない。")
      (cmd:203 1 0)
      (exec-mem 12288 0 20 (bytes 235 186) 42 270 0 1021 2)
      (cmd:203 1 1)
 ...
 (seg (? (= X 2) (= S 4) (= 554 #t))
      (nop@)
      (exec-mem 14080 0)
      (exec-mem 8192 "G 10 14 200 28 64")
      (exec-mem 256 14 25 27 8 1 1 0 2560 2560 1 1)
      (exec-mem 256 14 25 26 7 1 0 0 2560 2560 1 0)
      (text-frame 15 210 79 275)
      (text "今はそっとしておいた方が" 'br)
      (text "いいな")
      (text-raw 60393 60393 60393)
      (cmd:203 1 0)
      (exec-mem 12288 0 20 (bytes 235 186) 37 230 0 1021 2)
      (cmd:203 1 1)
 ...
 (seg*
  ...
  (exec-mem 4096 "EXIT")
  (if (</>
       (// (? (= W 18)) (nop@) (mes-jump "b:¥mes¥109_0.mes"))
       (// (? (= W 19)) (nop@) (mes-jump "b:¥mes¥109_1.mes"))
       (//
        (? (= W 20))
        (nop@)
        (branch-reg 551
         (</>
          (/ (mes-jump "b:¥mes¥109_2a.mes"))
          (/ (mes-jump "b:¥mes¥109_2b.mes")))))
       (//
        (? (= W 21))
        (nop@)
        (if (</>
             (// (? (= 552 #f)) (mes-jump "b:¥mes¥109_3a.mes"))
             (// (? (= 555 #t) (= 553 #f)) (mes-jump "b:¥mes¥109_3c.mes"))
             (// (mes-jump "b:¥mes¥109_3b.mes")))))
       (//
        (? (= W 1))
        (nop@)
        (if (</>
             (//
              (? (= 700 #f) (= 551 #t) (= 552 #t) (= 701 #f))
              (mes-jump "b:¥mes¥109_4a.mes"))
             (// (nop@) (mes-jump "b:¥mes¥109_4b.mes")))))
       (//
        (? (= W 10))
        (nop@)
        (branch-reg 556
         (</>
          (/ (mes-jump "b:¥mes¥109_6a.mes"))
          (/ (mes-jump "b:¥mes¥109_6b.mes")))))
       (// (? (!= W 0) (!= W 9)) (nop@) (seg-call))
       (// (nop@) (mes-jump "b:¥mes¥109_5.mes")))))
 (seg*
