 ...
 (seg*
  ...
  (if (</>
       (//
        ...
        (if (</>
             (//
              (? (= 803 #t) (= 500 #t) (= 501 #f) (= 502 #f))
              (nop@)
              (mes-jump "b:¥mes¥111_0t.mes"))
             (// (? (= 501 #t)) (nop@) (mes-jump "b:¥mes¥112.mes"))
             (// (nop@) (mes-jump "b:¥mes¥111_0.mes")))))
       (// (? (= W 19)) (nop@) (mes-jump "b:¥mes¥111_1.mes"))
       (// (? (= W 20)) (nop@) (mes-jump "b:¥mes¥111_2.mes"))
       (// (? (= W 10)) (nop@) (mes-jump "b:¥mes¥111_4.mes"))
       (// (? (!= W 0) (!= W 9)) (nop@) (seg-call))
       (// (nop@) (mes-jump "b:¥mes¥111_3.mes")))))
 (seg*
