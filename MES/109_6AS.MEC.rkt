(mes
 ...
 (seg (? (= F 0))
      ...
      (text-reset 0)
      (exec-mem 8192 "C 0 27 282 21 104 1 38 144")
      ...
      (if (</>
           ...
           (//
            ...
            (exec-mem 8192
             "O 1,C 1 22 0 21 84 1 0 0,C 1 22 88 21 16 1 0 84,O 0"))))
      (exec-mem 8192 "C 1 0 0 21 104 0 27 282")
      (exec-mem 35072 "S=H'[N]")
      (cmd:203 5 16 1)
      (cmd:211 0 1)
      (text-frame 28 288 46 367)
      (menu1 28 290
       (</>
        (/ (set-reg 0 #t) (proc 0))
        (/ (set-reg 1 #t) (proc 1))
 ...
 (seg (? (= F 1)) (exec-mem 8192 "C 1 38 144 21 104 0 27 282") (set-reg 26 #f)))