...
(mes
 ...
 (seg*
  ...
  ; Can I just change this here? Not sure. Says "Director Faber's house"
  (exec-mem 35072 "@0='ファーバー監督邸'")
     ...
     (branch-reg 110
      (</>
       (/
        ...
        (str "I'm currently at the home of John Fabio Faber, a legendary Hollywood director.")
        (proc 18)
        ...
        (str "Welcome. I'm ")
        (proc 14)
        (str ", Mr. Faber's only daughter." '60392)
        (proc 18)
        (text-frame 8 308 71 323)
        ; Actor: Jake Snipes
        ;(proc 12)
