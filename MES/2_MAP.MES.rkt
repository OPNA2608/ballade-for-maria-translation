(mes
 ...
 (seg (? (= X 2) (= S 2) (= 600 #t))
      (nop@)
      (exec-mem 14080 0)
      (exec-mem 8192 "G 10 24 176 42 64")
      (exec-mem 256 24 22 41 8 1 1 0 2560 2560 1 1)
      (exec-mem 256 24 22 40 7 1 0 0 2560 2560 1 0)
      (text-frame 25 186 79 275)
      (text "アンナから聞けることは聞き出した")
      (text-raw 60393 60393 60393)
      (text 'br)
      (text "もうあの場所へ行く必要はないだろう。")
      (cmd:203 1 0)
      (exec-mem 12288 0 20 (bytes 235 186) 61 206 0 1021 2)
      (cmd:203 1 1)
      (exec-mem 8192 "P 10 24 176,F 10,P 2 24 134,A 1")
      (exec-mem 4096 "COPY gpc¥map2.gpc,GPC")
      (image-mem 0)
      (exec-mem 8192 "A 0")
      (exec-mem 17664 31 160 32 175 9 0)
      (repeat (<> (set-reg 131 #t) (nop@) (exec-mem 14080)))
      (exec-mem 14080 1)
      (set-var T 0)
      (set-reg 601 #t)
 ...
 (seg (? (= X 0) (= S 2) (= 605 #t))
      (nop@)
      (exec-mem 14080 0)
      (exec-mem 8192 "G 10 15 240 46 64")
      (exec-mem 256 15 30 45 8 1 1 0 2560 2560 1 1)
      (exec-mem 256 15 30 44 7 1 0 0 2560 2560 1 0)
      (text-frame 16 250 79 275)
      (text "エヴァの言葉を信じるなら、ガイはしばらく" 'br)
      (text "戻って来ない。他の場所へ行く事にしよう。")
      (cmd:203 1 0)
      (exec-mem 12288 0 20 (bytes 235 186) 56 270 0 1021 2)
      (cmd:203 1 1)
      (exec-mem 8192 "P 10 15 240,F 10,P 2 15 198,A 1")
      (exec-mem 4096 "COPY gpc¥map0.gpc,GPC")
      (image-mem 0)
      (exec-mem 8192 "A 0")
      (exec-mem 17664 19 224 20 239 9 0)
      (repeat (<> (set-reg 131 #t) (nop@) (exec-mem 14080)))
      (exec-mem 14080 1)
      (set-var T 0)
      (set-reg 606 #t)
 ...
 (seg*
  ...
  (if (</>
       (//
        ...
        (nop@)
        (if (</>
             (// (? (= W 18)) (nop@) (mes-jump "b:¥mes¥201_0.mes"))
             (// (? (= W 19)) (nop@) (mes-jump "b:¥mes¥201_1.mes"))
             (// (? (= W 20)) (nop@) (mes-jump "b:¥mes¥201_2.mes"))
             (// (? (= W 21)) (nop@) (mes-jump "b:¥mes¥201_3.mes"))
             (// (? (= W 1)) (nop@) (mes-jump "b:¥mes¥201_4.mes"))
             (// (? (= W 10)) (nop@) (mes-jump "b:¥mes¥201_6.mes"))
             (// (? (= W 11)) (nop@) (mes-jump "b:¥mes¥201_7.mes"))
             (// (? (= W 2)) (nop@) (mes-jump "b:¥mes¥201_8.mes"))
             (// (? (!= W 0) (!= W 9)) (nop@) (seg-call))
             (// (nop@) (mes-jump "b:¥mes¥201_5.mes")))))
       (//
        (? (= 793 #f))
        (nop@)
        (if (</>
             (// (? (= W 18)) (nop@) (mes-jump "b:¥mes¥202_0.mes"))
             (// (? (= W 20)) (nop@) (mes-jump "b:¥mes¥201_2.mes"))
             (// (? (= W 21)) (nop@) (mes-jump "b:¥mes¥201_3.mes"))
             (// (? (= W 1)) (nop@) (mes-jump "b:¥mes¥201_4.mes"))
             (// (? (= W 10)) (nop@) (mes-jump "b:¥mes¥202_6.mes"))
             (// (? (= W 11)) (nop@) (mes-jump "b:¥mes¥201_7.mes"))
             (// (? (= W 2)) (nop@) (mes-jump "b:¥mes¥201_8.mes"))
             (// (? (!= W 0) (!= W 9)) (nop@) (seg-call))
             (// (nop@) (mes-jump "b:¥mes¥202_5.mes")))))
       (//
        (? (= 794 #f))
        (nop@)
        (if (</>
             (//
              ...
              (nop@)
              (if (</>
                   (// (? (= 618 #t)) (nop@) (mes-jump "b:¥mes¥205_0b.mes"))
                   (//
                    (? (= 615 #t) (= 617 #t) (= 619 #t))
                    (nop@)
                    (mes-jump "b:¥mes¥205_0s.mes"))
                   (// (nop@) (mes-jump "b:¥mes¥205_0a.mes")))))
             (// (? (= W 20)) (nop@) (mes-jump "b:¥mes¥201_2.mes"))
             (// (? (= W 21)) (nop@) (mes-jump "b:¥mes¥205_3.mes"))
             (// (? (= W 1)) (nop@) (mes-jump "b:¥mes¥201_4.mes"))
             (// (? (= W 10)) (nop@) (mes-jump "b:¥mes¥201_6.mes"))
             (// (? (= W 11)) (nop@) (mes-jump "b:¥mes¥205_7.mes"))
             (// (? (= W 2)) (nop@) (mes-jump "b:¥mes¥205_8.mes"))
             (// (? (= W 12)) (nop@) (mes-jump "b:¥mes¥205_9.mes"))
             (// (? (= W 3)) (nop@) (mes-jump "b:¥mes¥205_A.mes"))
             (// (? (= W 22)) (nop@) (mes-jump "b:¥mes¥205_B.mes"))
             (// (? (!= W 0) (!= W 9)) (nop@) (seg-call))
             (// (nop@) (mes-jump "b:¥mes¥201_5.mes")))))
       (//
        (? (= 795 #f))
             ...
             (//
              ...
              (if (</>
                   (//
                    (? (= 624 #t) (= 626 #t) (= 625 #f))
                    (nop@)
                    (mes-jump "b:¥mes¥207_0a.mes"))
                   (// (nop@) (mes-jump "b:¥mes¥207_0.mes")))))
             (// (? (= W 20)) (nop@) (mes-jump "b:¥mes¥201_2.mes"))
             (// (? (= W 21)) (nop@) (mes-jump "b:¥mes¥207_3.mes"))
             (// (? (= W 1)) (nop@) (mes-jump "b:¥mes¥201_4.mes"))
             (//
              (? (= W 10))
              (nop@)
              (branch-reg 625
               (</>
                (/ (mes-jump "b:¥mes¥207_6a.mes"))
                (/ (mes-jump "b:¥mes¥207_6.mes")))))
             (//
              (? (= W 11))
              (nop@)
              (branch-reg 622
               (</>
                (/ (mes-jump "b:¥mes¥205_7.mes"))
                (/ (mes-jump "b:¥mes¥207_7.mes")))))
             (// (? (= W 2)) (nop@) (mes-jump "b:¥mes¥207_8.mes"))
             (// (? (= W 12)) (nop@) (mes-jump "b:¥mes¥205_9.mes"))
             (// (? (= W 3)) (nop@) (mes-jump "b:¥mes¥207_A.mes"))
             (// (? (= W 22)) (nop@) (mes-jump "b:¥mes¥205_B.mes"))
             (// (? (= W 23)) (nop@) (mes-jump "b:¥mes¥207_C.mes"))
             (// (? (!= W 0) (!= W 9)) (nop@) (seg-call))
             (//
              (nop@)
              (if (</>
                   (//
                    (? (= 623 #t) (= 624 #f))
                    (nop@)
                    (mes-jump "b:¥mes¥207_5.mes"))
                   (// (nop@) (mes-jump "b:¥mes¥207_5a.mes"))))))))
       (//
        (nop@)
        (if (</>
             (//
              ...
              (if (</>
                   (//
                    (? (= 630 #t) (= 628 #f))
                    (nop@)
                    (mes-jump "b:¥mes¥208_0a.mes"))
                   (// (nop@) (mes-jump "b:¥mes¥208_0.mes")))))
             (// (? (= W 20)) (nop@) (mes-jump "b:¥mes¥201_2.mes"))
             (// (? (= W 21)) (nop@) (mes-jump "b:¥mes¥208_3.mes"))
             (// (? (= W 1)) (nop@) (mes-jump "b:¥mes¥201_4.mes"))
             (// (? (= W 10)) (nop@) (mes-jump "b:¥mes¥201_6.mes"))
             (// (? (= W 11)) (nop@) (mes-jump "b:¥mes¥205_7.mes"))
             (// (? (= W 2)) (nop@) (mes-jump "b:¥mes¥207_8.mes"))
             ...
             (//
              ...
              (branch-reg 620
               (</>
                (/ (mes-jump "b:¥mes¥205_B.mes"))
                (/ (mes-jump "b:¥mes¥208_B.mes")))))
             (// (? (= W 23)) (nop@) (mes-jump "b:¥mes¥207_C.mes"))
             (//
              (? (= W 13))
              (nop@)
              (branch-reg 627
               (</>
                (/ (mes-jump "b:¥mes¥208_Da.mes"))
                (/ (mes-jump "b:¥mes¥208_D.mes")))))
             (// (? (!= W 0) (!= W 9)) (nop@) (seg-call))
             (//
              (nop@)
              (if (</>
                   (// (? (= 627 #f)) (nop@) (mes-jump "b:¥mes¥208_5a.mes"))
                   (//
                    (? (= 628 #t) (= 631 #f))
                    (nop@)
                    (mes-jump "b:¥mes¥208_5t.mes"))
