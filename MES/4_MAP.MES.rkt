(mes
 ...
 (seg*
  (if (</> (// (? (!= M 3) (!= M 0)) (nop@) (sound ' 2))))
  (cmd:209 0 2)
  (text-color 0 2 2)
  (cmd:203 1 1)
  (set-var F 0)
  (cmd:204 100 199)
  (exec-mem 35072 "#101=#794")
  (set-reg 103 #t)
  (exec-mem 35072 "#104=(#756==0)")
  (set-reg 105 #t)
  (set-reg 111 #t)
  (set-reg 112 #t)
  (exec-mem 35072 "#113=(#750==0)")
  (set-reg 114 #t)
  (exec-mem 35072 "#115=#794")
  (set-reg 116 #t)
  (exec-mem 35072 "#117=(#703==1)&(#751==0)")
  (set-reg 120 #t)
  (set-reg 123 #t)
  (exec-mem 35072 "#124=(#753==0)")
  (exec-mem 35072 "#125=(#793==1)&(#754==0)")
  (exec-mem 35072 "#126=(#755==0)")
 ...
 (seg (? (!= S T))
      ...
      (exec-mem 14080 1)
      (set-var T S))
 (seg (? (= X 0) (= S 5) (= 715 #t) (= 756 #f))
      (nop@)
      (exec-mem 14080 0)
      (exec-mem 8192 "G 10 25 320 54 64")
      (exec-mem 256 25 40 53 8 1 1 0 2560 2560 1 1)
      (exec-mem 256 25 40 52 7 1 0 0 2560 2560 1 0)
      (text-frame 26 330 75 365)
      (text "ゴードンのあの様子じゃ、僕の顔を見たとたんに撃ち" 'br)
      (text "殺されそうだったな。カスバには二度と行けないぞ。")
      (cmd:203 1 0)
      (exec-mem 12288 0 20 (bytes 235 186) 74 350 0 1021 2)
      (cmd:203 1 1)
      (exec-mem 8192 "P 10 25 320,F 10,P 2 9 318,A 1")
      (exec-mem 4096 "COPY gpc¥map0.gpc,GPC")
      (image-mem 0 0)
      (exec-mem 8192 "A 0")
      (exec-mem 17664 16 344 17 359 9 0)
      (repeat (<> (set-reg 131 #t) (nop@) (exec-mem 14080)))
      (exec-mem 14080 1)
      (set-var T 0)
      (set-reg 756 #t)
      (set-reg 104 #f))
 (seg (? (= X 1) (= S 4) (= 714 #t) (= 750 #f))
      (nop@)
      (exec-mem 14080 0)
      (exec-mem 8192 "G 10 7 296 48 64")
      (exec-mem 256 7 37 47 8 1 1 0 2560 2560 1 1)
      (exec-mem 256 7 37 46 7 1 0 0 2560 2560 1 0)
      (text-frame 8 306 51 341)
      (text "つい、いつもの習慣でＦＬＩＸへと来てしまっ" 'br)
      (text "たが、もうティムはここにはいないのだった。")
      (cmd:203 1 0)
      (exec-mem 12288 0 20 (bytes 235 186) 50 326 0 1021 2)
      (cmd:203 1 1)
      (text-reset)
      (text "ティムがいないＦＬＩＸへはもう用はなかった" 'br)
      (text "んだ")
      (text-raw 60393 60393 60393)
      (cmd:203 1 0)
      (exec-mem 12288 0 20 (bytes 235 186) 50 326 0 1021 2)
      (cmd:203 1 1)
      (exec-mem 8192 "P 10 7 296,F 10,P 2 7 254,A 1")
      (exec-mem 4096 "COPY gpc¥map1.gpc,GPC")
      (image-mem 0 0)
      (exec-mem 8192 "A 0")
      (exec-mem 17664 14 280 15 295 9 0)
      (repeat (<> (set-reg 131 #t) (nop@) (exec-mem 14080)))
      (exec-mem 14080 1)
      (set-var T 0)
      (set-reg 750 #t)
      (set-reg 113 #f))
 (seg (? (= X 1) (= S 8) (= 792 #t) (= 751 #f))
      (nop@)
      (exec-mem 14080 0)
      (exec-mem 8192 "G 10 25 288 30 64")
      (exec-mem 256 25 36 29 8 1 1 0 2560 2560 1 1)
      (exec-mem 256 25 36 28 7 1 0 0 2560 2560 1 0)
      (text-frame 26 298 51 333)
      (text "アンジュから聞けることは" 'br)
      (text "すべて聞いたはずだ。")
      (cmd:203 1 0)
      (exec-mem 12288 0 20 (bytes 235 186) 50 318 0 1021 2)
      (cmd:203 1 1)
      (text-reset)
      (text "もうあの店に入ることはな" 'br)
      (text "いだろうな。")
      (cmd:203 1 0)
      (exec-mem 12288 0 20 (bytes 235 186) 50 318 0 1021 2)
      (cmd:203 1 1)
      (exec-mem 8192 "P 10 25 288,F 10,P 2 25 246,A 1")
      (exec-mem 4096 "COPY gpc¥map1.gpc,GPC")
      (image-mem 0 0)
      (exec-mem 8192 "A 0")
      (exec-mem 17664 33 272 34 287 9 0)
      (repeat (<> (set-reg 131 #t) (nop@) (exec-mem 14080)))
      (exec-mem 14080 1)
      (set-var T 0)
      (set-reg 751 #t)
      (set-reg 117 #f))
 (seg (? (= X 2) (= S 5) (= 752 #t) (= 753 #f))
      (nop@)
      (exec-mem 14080 0)
      (exec-mem 8192 "G 10 33 88 42 64")
      (exec-mem 256 33 11 41 8 1 1 0 2560 2560 1 1)
      (exec-mem 256 33 11 40 7 1 0 0 2560 2560 1 0)
      (text-frame 34 98 71 123)
      (text "ティムは田舎に帰ると言っていた。もう" 'br)
      (text "彼の家を訪ねる必要はないだろう。")
      (cmd:203 1 0)
      (exec-mem 12288 0 20 (bytes 235 186) 70 118 0 1021 2)
      (cmd:203 1 1)
      (exec-mem 8192 "P 10 33 88,F 10,P 2 33 46,A 1")
      (exec-mem 4096 "COPY gpc¥map2.gpc,GPC")
      (image-mem 0 0)
      (exec-mem 8192 "A 0")
      (exec-mem 17664 38 72 39 87 9 0)
      (repeat (<> (set-reg 131 #t) (nop@) (exec-mem 14080)))
      (exec-mem 14080 1)
      (set-var T 0)
      (set-reg 753 #t)
      (set-reg 124 #f))
 (seg (? (= X 2) (= S 6) (= 721 #t) (= 754 #f))
      (nop@)
      (exec-mem 14080 0)
      (exec-mem 8192 "G 10 36 336 24 64")
      (exec-mem 256 36 42 23 8 1 1 0 2560 2560 1 1)
      (exec-mem 256 36 42 22 7 1 0 0 2560 2560 1 0)
      (text-frame 37 346 56 381)
      (text "もうガリソンと会う" 'br)
      (text "必要はないよな。")
      (cmd:203 1 0)
      (exec-mem 12288 0 20 (bytes 235 186) 55 368 0 1021 2)
      (cmd:203 1 1)
      (exec-mem 8192 "P 10 36 336,F 10,P 2 36 302,A 1")
      (exec-mem 4096 "COPY gpc¥map2.gpc,GPC")
      (image-mem 0 0)
      (exec-mem 8192 "A 0")
      ...
      (set-reg 754 #t)
      (set-reg 125 #f))
 (seg (? (= X 2) (= S 7) (= 701 #t) (= 755 #f))
      (nop@)
      (exec-mem 14080 0)
      (exec-mem 8192 "G 10 8 48 36 64")
      (exec-mem 256 8 6 35 8 1 1 0 2560 2560 1 1)
      (exec-mem 256 8 6 34 7 1 0 0 2560 2560 1 0)
      (text-frame 9 58 40 93)
      (text "ロケは中止になったそうだから、" 'br)
      (text "行っても誰もいないだろうな。")
      (cmd:203 1 0)
      (exec-mem 12288 0 20 (bytes 235 186) 39 78 0 1021 2)
      (cmd:203 1 1)
      (exec-mem 8192 "P 10 8 48,F 10,P 2 8 6,A 1")
      (exec-mem 4096 "COPY gpc¥map2.gpc,GPC")
      (image-mem 0 0)
      (exec-mem 8192 "A 0")
      (exec-mem 17664 17 32 18 47 9 0)
      (repeat (<> (set-reg 131 #t) (nop@) (exec-mem 14080)))
      (exec-mem 14080 1)
      (set-var T 0)
      (set-reg 755 #t)
             ...
             (//
              ...
              (branch-reg 700
               (</>
                ...
                (/ (mes-jump "b:¥mes¥400_03b.mes")))))
             (// (? (= W 4)) (nop@) (mes-jump "b:¥mes¥400_04.mes"))
             (// (? (= W 5)) (nop@) (mes-jump "b:¥mes¥400_05.mes"))
             (// (? (= W 10)) (nop@) (mes-jump "b:¥mes¥400_10.mes"))
             (// (? (= W 11)) (nop@) (mes-jump "b:¥mes¥400_11.mes"))
             (// (? (= W 12)) (nop@) (mes-jump "b:¥mes¥400_12.mes"))
             (// (? (= W 13)) (nop@) (mes-jump "b:¥mes¥400_13.mes"))
             (// (? (= W 15)) (nop@) (mes-jump "b:¥mes¥400_15.mes"))
             (// (? (= W 16)) (nop@) (mes-jump "b:¥mes¥400_16.mes"))
             (// (? (= W 18)) (nop@) (mes-jump "b:¥mes¥400_18.mes"))
             (// (? (= W 21)) (nop@) (mes-jump "b:¥mes¥400_21.mes"))
             (// (? (= W 22)) (nop@) (mes-jump "b:¥mes¥400_22.mes"))
             (// (? (= W 24)) (nop@) (mes-jump "b:¥mes¥400_24.mes"))
             (// (nop@) (seg-call)))))
       (//
        (? (= 793 #f))
        (if (</>
             (// (? (= W 3)) (nop@) (mes-jump "b:¥mes¥400_03b.mes"))
             (// (? (= W 4)) (nop@) (mes-jump "b:¥mes¥403_04.mes"))
             (// (? (= W 5)) (nop@) (mes-jump "b:¥mes¥403_05.mes"))
             (// (? (= W 10)) (nop@) (mes-jump "b:¥mes¥403_10.mes"))
             (// (? (= W 11)) (nop@) (mes-jump "b:¥mes¥403_11.mes"))
             (// (? (= W 12)) (nop@) (mes-jump "b:¥mes¥403_12.mes"))
             (// (? (= W 13)) (nop@) (mes-jump "b:¥mes¥403_13.mes"))
             (// (? (= W 15)) (nop@) (mes-jump "b:¥mes¥403_15.mes"))
             (// (? (= W 18)) (nop@) (mes-jump "b:¥mes¥403_18.mes"))
             (// (? (= W 21)) (nop@) (mes-jump "b:¥mes¥403_21.mes"))
             (//
              (? (= W 22))
              (nop@)
              (branch-reg 707
               (</>
                (/ (mes-jump "b:¥mes¥400_22.mes"))
                (/ (mes-jump "b:¥mes¥403_22.mes")))))
             (// (nop@) (seg-call)))))
       (//
        (? (= 794 #f))
        (if (</>
             (// (? (= W 3)) (nop@) (mes-jump "b:¥mes¥400_03b.mes"))
             (// (? (= W 4)) (nop@) (mes-jump "b:¥mes¥403_04.mes"))
             (// (? (= W 5)) (nop@) (mes-jump "b:¥mes¥405_05.mes"))
             (// (? (= W 10)) (nop@) (mes-jump "b:¥mes¥405_10.mes"))
             (// (? (= W 11)) (nop@) (mes-jump "b:¥mes¥400_11.mes"))
             (// (? (= W 12)) (nop@) (mes-jump "b:¥mes¥403_12.mes"))
             (// (? (= W 13)) (nop@) (mes-jump "b:¥mes¥405_13.mes"))
             (// (? (= W 15)) (nop@) (mes-jump "b:¥mes¥405_15.mes"))
             (// (? (= W 18)) (nop@) (mes-jump "b:¥mes¥405_18.mes"))
             (// (? (= W 21)) (nop@) (mes-jump "b:¥mes¥405_21.mes"))
             (// (? (= W 22)) (nop@) (mes-jump "b:¥mes¥400_22.mes"))
             (// (? (= W 23)) (nop@) (mes-jump "b:¥mes¥405_23.mes"))
             (// (nop@) (seg-call)))))
       (//
        (? (= 795 #f))
        (if (</>
             (// (? (= W 1)) (nop@) (mes-jump "b:¥mes¥408_01.mes"))
             (// (? (= W 3)) (nop@) (mes-jump "b:¥mes¥408_03.mes"))
             (//
              (? (= W 4))
              (nop@)
              (branch-reg 723
               (</>
                (/ (mes-jump "b:¥mes¥408_04a.mes"))
                (/ (mes-jump "b:¥mes¥408_04b.mes")))))
             (// (? (= W 5)) (nop@) (mes-jump "b:¥mes¥405_05.mes"))
             (// (? (= W 10)) (nop@) (mes-jump "b:¥mes¥408_10.mes"))
             (//
              (? (= W 11))
              (nop@)
              (branch-reg 722
               (</>
                (/ (mes-jump "b:¥mes¥400_11.mes"))
                (/ (mes-jump "b:¥mes¥408_11.mes")))))
             (// (? (= W 12)) (nop@) (mes-jump "b:¥mes¥408_12.mes"))
             (// (? (= W 13)) (nop@) (mes-jump "b:¥mes¥408_13.mes"))
             (// (? (= W 14)) (nop@) (mes-jump "b:¥mes¥408_14.mes"))
             (// (? (= W 15)) (nop@) (mes-jump "b:¥mes¥408_15.mes"))
             (// (? (= W 18)) (nop@) (mes-jump "b:¥mes¥408_18.mes"))
             (// (? (= W 21)) (nop@) (mes-jump "b:¥mes¥408_21.mes"))
             (// (? (= W 22)) (nop@) (mes-jump "b:¥mes¥400_22.mes"))
             (// (? (= W 23)) (nop@) (mes-jump "b:¥mes¥408_23.mes"))
             (// (nop@) (seg-call)))))
       (//
        (if (</>
             (// (? (= W 1)) (nop@) (mes-jump "b:¥mes¥410_01.mes"))
             (// (? (= W 3)) (nop@) (mes-jump "b:¥mes¥410_03.mes"))
             (// (? (= W 5)) (nop@) (mes-jump "b:¥mes¥400_05.mes"))
             (// (? (= W 10)) (nop@) (mes-jump "b:¥mes¥408_10.mes"))
             (// (? (= W 11)) (nop@) (mes-jump "b:¥mes¥400_11.mes"))
             (// (? (= W 13)) (nop@) (mes-jump "b:¥mes¥408_13.mes"))
             (// (? (= W 14)) (nop@) (mes-jump "b:¥mes¥410_14.mes"))
             (// (? (= W 15)) (nop@) (mes-jump "b:¥mes¥403_15.mes"))
             (// (? (= W 18)) (nop@) (mes-jump "b:¥mes¥410_18.mes"))
             (// (? (= W 21)) (nop@) (mes-jump "b:¥mes¥410_21.mes"))
             (// (? (= W 22)) (nop@) (mes-jump "b:¥mes¥410_22.mes"))
             (// (nop@) (seg-call))))))))
 (seg*
